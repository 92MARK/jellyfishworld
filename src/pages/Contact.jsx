            ...
            <form onSubmit={handleSubmit} className={styles.form} noValidate>
              ...
              <div className={styles.field}>
                <label className={styles.label}>
                  ...
                  <span
                    className={`${styles.charCount} ${form.message.length >= 900 ? styles.charCountWarn : ""} ${form.message.length >= 1000 ? styles.charCountMax : ""}`}
                  >
